	...
	<div class="welcome-area" id="welcome">
		...
		<div class="container">
			...
			<div class="column left-text col-lg-4 col-md-6 col-sm-6 col-xs-6" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s" Style=" ">
			    <form action="SvModificarPaqueteTuristico" method="POST" style="">
				<h1>Modificar Paquete Turistico</h1>
			...
			<div class="column left-text col-lg-8 col-md-6 col-sm-6 col-xs-6" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s" style="margin-top: 350px">
			    <form action="SvAgregarServicioAPaqueteMod" method="post">
				...
				String servicios = "";
				for (ServicioTuristico servicioTuristico : serviciosParaPaquete) {
				...
				servicios = servicios + ".";
			    %>
			    <form action="SvQuitarServiciosAPaqueteMod" method="POST">
				<div><input type="text" name="serviciosElegidos" style="width: 250px; display:inline" readonly="" value="<%=servicios%>">
