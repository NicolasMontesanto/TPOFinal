			...
			<div class="table100 ver1">
				...
				<table style="margin-left: -250px; width: 550px ">
					...
					<%
					    ...
					    for (ServicioTuristico servicioTuristico : listaServiciosTuristicos) {
						int id = servicioTuristico.getCod_servicio();
					%>
					<tr class="row100 body">
					    <td class="cell100 column1"><%=servicioTuristico.getNombre() %></td>
					    <td class="cell100 column2">
						<form name="formBajaServicioTuristico" action="SvBajaServicioTuristico" method="POST" style="display:inline">
						    <input type="hidden" name="id" value="<%=id%>">
						    <button type="submit" class="btn-danger" data-title="Delete" style="display:inline">Eliminar</button>	
						</form>
					    </td>
					    <td class="cell100 column3">
						<form name="formModificarServicioTuristico" action="SvModificarServicioTuristico" method="GET" style="display:inline">
						    <input type="hidden" name="id" value="<%=id%>">
						    <button type="submit" class="btn-primary" data-title="Edit" style="display:inline">Modificar</button>
						</form>
					    </td>
					    <td class="cell100 column3">
						<form name="formVentasServicioTuristico" action="SvVentasServicioTuristico" method="GET" style="display:inline">
						    <input type="hidden" name="id" value="<%=id%>">
				...
				<div class="table100-nextcols">
					...
					<thead>
					    <tr class="row100 head">
						<th class="cell100 column7" style="width: 500px">Descripción</th>
						<th class="cell100 column7" style="width: 100px">Destino</th>
						<th class="cell100 column7" style="width: 200px">Fecha</th>
						<th class="cell100 column10" style="width: 100px">Costo</th>
					    </tr>
					</thead>
					<tbody>
					    <%
						List<ServicioTuristico> listaServiciosTuristicos2 = (List) request.getSession().getAttribute("listaServiciosTuristicos");
						for (ServicioTuristico servicioTuristico : listaServiciosTuristicos2) {

					    %>
					    <tr class="row100 body">
						<td class="cell100 column2" style="padding-left: 0px"><%=servicioTuristico.getDescripcion()%></td>
						<td class="cell100 column2" style="padding-left: 0px"><%=servicioTuristico.getDestino_servicio() %></td>
						<td class="cell100 column2" style="padding-left: 0px"><%=servicioTuristico.getFecha_servicio() %></td>
						<td class="cell100 column2" style="padding-left: 0px"><%=servicioTuristico.getCosto_servicio() %></td>
					    </tr>
					    <%}%>
					</tbody>
				    </table>
