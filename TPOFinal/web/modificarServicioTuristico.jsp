...
<html lang="es">
	...
	<div class="welcome-area" id="welcome">
		...
		<div class="container">
		    <form action="SvModificarServicioTuristico" method="POST" style="margin-top:0px">
			<div class="row">
				...
				<h1>Modificar Servicio Turistico</h1>
				...
				%>
				<p><input type="text" name="nombre" style="width: 250px;" value="<%=servicioTuristico.getNombre() %>"></p>
				<p><input type="text" name="descripcion" style="width: 250px;" value="<%=servicioTuristico.getDescripcion() %>"></p>
				<p><input type="text" name="destino" style="width: 250px;" value="<%=servicioTuristico.getDestino_servicio() %>"></p>
				<p><input type="text" name="fecha" style="width: 250px;" value="<%=servicioTuristico.getFecha_servicio() %>"></p>
				<p><input type="text" name="costo" style="width: 250px;" value="<%=servicioTuristico.getCosto_servicio() %>"></p>
			    </div>
			</div>
		    </form>
		</div>
