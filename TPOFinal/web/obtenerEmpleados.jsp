		...
		<div class="container-table100">
			...
			<div class="table100 ver1">
				...
				<table style="margin-left: -250px; width: 550px ">
					...
					%>
					<tr class="row100 body"> <%String nombreCompleto = empleado.getNombre() + " " + empleado.getApellido();%>
					    <td class="cell100 column1"><%=nombreCompleto%></td>
					    <td class="cell100 column2">
						<form name="formBajaEmpleado" action="SvBajaEmpleado" method="POST" style="display:inline">
						    <input type="hidden" name="id" value="<%=id%>">
						    <button type="submit" class="btn-danger" data-title="Delete" style="display:inline">Eliminar</button>	
						</form>
					    </td>
					    <td class="cell100 column3">
						<form name="formModificarEmpleado" action="SvModificarEmpleado" method="GET" style="display:inline">
						    <input type="hidden" name="id" value="<%=id%>">
						    <button type="submit" class="btn-primary" data-title="Edit" style="display:inline">Modificar</button>
						</form>
					    </td>
					    <td class="cell100 column3">
						<form name="formVentasEmpleado" action="SvVentasEmpleado" method="GET" style="display:inline">
						    <input type="hidden" name="id" value="<%=id%>">
				...
				<div class="table100-nextcols">
					...
					<thead>
					    <tr class="row100 head">
						<th class="cell100 column7" style="width: 100px">Cargo</th>
						<th class="cell100 column7" style="width: 100px">Sueldo</th>
						<th class="cell100 column7" style="width: 200px">Nombre Usuario</th>
					...
					<tbody>
					    <%
						List<Empleado> listaEmpleados2 = (List) request.getSession().getAttribute("listaEmpleados");
						for (Empleado empleado : listaEmpleados2) {

					    %>
					    <tr class="row100 body">
						<td class="cell100 column2" style="padding-left: 0px"><%=empleado.getCargo()%></td>
						<td class="cell100 column2" style="padding-left: 0px"><%=empleado.getSueldo()%></td>
						<td class="cell100 column2" style="padding-left: 0px"><%=empleado.getUsuario().getNombre_usuario()%></td>
						<td class="cell100 column2" style="padding-left: 0px"><%=empleado.getId_persona()%></td>
						<td class="cell100 column2" style="padding-left: 0px"><%=empleado.getDireccion()%></td>
						<td class="cell100 column3" style="padding-left: 0px"><%=empleado.getDni()%></td>
						<td class="cell100 column4" style="padding-left: 0px"><%=empleado.getFecha_nac()%></td>
						<td class="cell100 column5" style="padding-left: 0px"><%=empleado.getNacionalidad()%></td>
						<td class="cell100 column6" style="padding-left: 0px"><%=empleado.getCelular()%></td>
						<td class="cell100 column7" style="padding-left: 0px"><%=empleado.getEmail()%></td>
					    </tr>
					    <%}%>
					</tbody>
				    </table>
