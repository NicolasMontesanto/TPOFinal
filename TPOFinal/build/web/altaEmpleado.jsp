...
<html lang="es">
	...
	<div class="welcome-area" id="welcome">
		...
		<div class="container">
		    <form action="SvEmpleado" method="POST" style="margin-top:80px">
			<div class="row">
				...
				<p><input type="text" name="nombreUsuario" style="width: 250px;"></p>
				<p><input type="password" name="contrasenia" style="width: 250px;"></p>
				<p><input type="text" name="nombre" style="width: 250px;"></p>
				<p><input type="text" name="apellido" style="width: 250px;"></p>
				<p><input type="text" name="cargo" style="width: 250px;"></p>
				<p><input type="text" name="sueldo" style="width: 250px;"></p>
				<p><input type="text" name="direccion" style="width: 250px;"></p>
				<p><input type="text" name="dni" style="width: 250px;"></p>
				<p><input type="text" name="fecha_nac" style="width: 250px;"></p>
				<p><input type="text" name="nacionalidad" style="width: 250px;"></p>
				<p><input type="text" name="celular" style="width: 250px;"></p>
				<p><input type="text" name="email" style="width: 250px;"> </p>
			    </div>
			</div>
		    </form>
		</div>
